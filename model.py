...
class Cherry(db.Model):
    ...
    carts = db.relationship("Cart", back_populates="cherries", secondary="cherry_carts")
...
class Cherry_Cart(db.Model):
    ...
    cherry_cart_id = db.Column(db.Integer, autoincrement=True, primary_key=True)
...
class Cart(db.Model):
    ...
    cherries = db.relationship("Cherry", back_populates="carts", secondary="cherry_carts")
